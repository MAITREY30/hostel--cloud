...
router.post(
  ...
  [
    ...
    check("cms_id", "ROLL NO of at least 7 digit is required").isLength(7),
    ...
    check("cnic", "Enter valid Aadhar").isLength(12),
...
router.post(
  "/update-student",
  [
    check("cms_id", "ROLL NO is required").not().isEmpty(),
    ...
    check("address", "Address is required").not().isEmpty(),
    check("dob", "Date of birth is required").not().isEmpty(),
    check("cnic", "Aadhar is required").not().isEmpty(),
