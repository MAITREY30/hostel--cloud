...
function Topbar({ name, notifications }) {
  ...
  return (
    <div className="py-5 px-5 flex items-center justify-between text-black w-full bg-white shadow-lg absolute top-0 md:w-[83.3vw] md:ml-[16.7vw]">
      ...
      <div className="flex gap-3">
        ...
        <div className="relative group cursor-pointer">
          ...
          <div className="absolute bg-neutral-800 -bottom-20 right-2 hidden text-white group-hover:flex flex-col rounded">
