...
function Sidebar({ links }) {
  ...
  return (
    <div>
      ...
      <div
        className={`flex flex-col justify-between h-screen w-screen absolute md:static sm:w-64 bg-white text-white transition-transform duration-300 ease-in-out z-40 transform ${
      ...
      >
        ...
        <div className="flex flex-col space-y-1 text-2xl text-black">
